...
public class ApiResponseMessage {
    ...
    static {
        ...
        message.put(ApiResponseCode.COMMAND_START_FAILURE.getCode(), "Starting background command with id %s failed");
        message.put(ApiResponseCode.COMMAND_STOP_FAILURE.getCode(), "Stopping running background command %s failed");
