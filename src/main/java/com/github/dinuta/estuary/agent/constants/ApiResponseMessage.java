...
public class ApiResponseMessage {
    ...
    static {
        ...
        message.put(ApiResponseCode.COMMAND_DETACHED_START_FAILURE.getCode(), "Starting test id %s failed");
        message.put(ApiResponseCode.TEST_STOP_FAILURE.getCode(), "Stopping running test %s failed");
