...
public class CommandParallelApiController implements CommandParallelApi {
    ...
    public ResponseEntity<ApiResponse<CommandDescription>> commandPost(@ApiParam(value = "Commands to run. E.g. ls -lrt", required = true) @Valid @RequestBody String commands, @ApiParam(value = "") @RequestHeader(value = "Token", required = false) String token) throws IOException {
